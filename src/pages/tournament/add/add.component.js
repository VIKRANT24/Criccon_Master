               ...
               <Modal show={showModalU} onHide={showEditUmpire} scrollable={true} >
                  ...
                  <Modal.Body>
                     ...
                     <Col md="12" className="mb-3">
                              ...
                              <Col md="12" className="mb-3">
                                 <Form.Label md="6" htmlFor="validationDefault01">State</Form.Label>
                                 <Form.Control type="text"  name="umpireState" onChange={(e) => setValue({ ...value, [e.target.name]: [e.target.value] })} required />
                              </Col>   
                              <Col md="12" className="mb-3">
                                 <Form.Label md="6" htmlFor="validationDefault01">City</Form.Label>
                                 <Form.Control type="text"  name="umpireCity" onChange={(e) => setValue({ ...value, [e.target.name]: [e.target.value] })} required />
                              </Col>      
                              <Col md="12" className="mb-3">
